<template>
    <div :class="[
        ...
        <main class="w-full">
            ...
            <!-- Patient Care Experience Section -->
                ...
                <div class="max-w-7xl mx-auto space-y-10">
                    ...
                    <div class="max-w-3xl space-y-4 text-left lg:max-w-none lg:mx-auto lg:text-center">
                        <h2
                            ...
                            A Complete Allergy <br class="lg:hidden" />
                            <span :class="isDarkMode ? 'text-[#00ffa3]' : 'text-orange-500'"
                                class="transition-colors duration-500">
                                Care Experience
                            </span>
                    ...
                    <div ref="cardsGrid" :class="isDarkMode ? 'text-neutral-300' : 'text-slate-700'"
                        ...
                        <p>
                            Patients can sign up and sign in within moments, then move straight to an appointment
                            scheduling dashboard that shows upcoming visits at a glance. Booking, rescheduling, and
                            tracking appointments all happen from the same simple screen, so care never feels out of
                            reach.
                        </p>
                        <p>
                            Detailed user and doctor profiles keep allergy history, treatment notes, and specialist
                            information organized in one place. Built-in in-app chat lets patients reach their doctors
                            directly, making it easy to ask questions or follow up between visits without waiting on a
                            phone call.
                        </p>
                        <p>
                            A dedicated contact page rounds things out, giving patients a quick way to get in touch with
                            the clinic for anything the app itself doesn't cover — keeping the full experience personal,
                            responsive, and easy to navigate from start to finish.
                        </p>
                    </div>
                </div>
            </section>
...
const appBenefits = [
    ...
    'User & Doctor Profiles with Allergy Data',
