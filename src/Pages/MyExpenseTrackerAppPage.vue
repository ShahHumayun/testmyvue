<template>
    <div :class="[
        ...
        <main class="w-full">
            ...
            <!-- Financial Management Experience Section -->
                ...
                <div class="max-w-7xl mx-auto space-y-10">
                    ...
                    <div class="max-w-3xl space-y-4 text-left lg:max-w-none lg:mx-auto lg:text-center">
                        <h2
                            ...
                            A Complete Expense <br class="lg:hidden" />
                            <span :class="isDarkMode ? 'text-[#00ffa3]' : 'text-orange-500'"
                                class="transition-colors duration-500">
                                Tracking Experience
                            </span>
                    ...
                    <div ref="cardsGrid" :class="isDarkMode ? 'text-neutral-300' : 'text-slate-700'"
                        ...
                        <p>
                            A single dashboard brings income, expenses, and balance together in one clear view, so users
                            always know exactly where their money stands without digging through separate screens or
                            manual calculations.
                        </p>
                        <p>
                            Income and expenses can be organized into their own categories, with support for multiple
                            payment methods. Adding a new income entry takes just a category selection and a payment
                            mode, keeping every transaction consistent and easy to review later.
                        </p>
                        <p>
                            From selecting and managing payment modes to fully tracking day-to-day spending, the app
                            handles the entire expense lifecycle — giving users a genuinely managed, hassle-free way to
                            stay on top of their personal finances.
                        </p>
                    </div>
                </div>
            </section>
...
const appBenefits = [
    'Income, Expense & Balance Dashboard',
    'Income & Expense Categories',
    'Multiple Payment Methods',
    'Add Income with Category Selection',
    'Select & Manage Payment Mode',
    'Fully Managed Expense Tracking'
]
