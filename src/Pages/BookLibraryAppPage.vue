<template>
    <div :class="[
        ...
        <main class="w-full">
            ...
            <!-- Reading Experience Section (now prose paragraphs instead of cards) -->
                ...
                <div class="max-w-7xl mx-auto space-y-10">
                    ...
                    <div class="max-w-3xl space-y-4 text-left lg:max-w-none lg:mx-auto lg:text-center">
                        <h2
                            ...
                            A Complete Digital <br class="lg:hidden" />
                            <span :class="isDarkMode ? 'text-[#00ffa3]' : 'text-orange-500'"
                                class="transition-colors duration-500">
                                Reading Experience
                            </span>
                    ...
                    <!-- Paragraphs replacing the feature cards -->
                    <div ref="cardsGrid" :class="isDarkMode ? 'text-neutral-300' : 'text-slate-700'"
                        ...
                        <p>
                            The app is engineered to bring a seamless reading journey directly to mobile devices, with a
                            focus on quick access and fluid navigation. Readers can explore extensive literary
                            collections categorized neatly across various genres, so finding the next book never feels
                            like a chore.
                        </p>
                        <p>
                            Dedicated sections cover Political, Historical, Stories, and Islamic literature, with dual
                            language support for both English and Urdu. This breaks language barriers and ensures a
                            comfortable, immersive experience for a wide reader demographic.
                        </p>
                        <p>
                            Built to state-of-the-art mobile performance standards, the app delivers smooth page
                            rendering, personalized bookshelf organizing tools, and instant search functionality —
                            whether readers are browsing offline or synchronizing their collections across devices.
                        </p>
                    </div>
                </div>
            </section>
...
onMounted(() => {
    ...
    // Paragraph Entrance Animation (was card grid animation)
    if (cardsGrid.value) {
        gsap.fromTo(
...
/* Phone mockup container sizing — trimmed slightly at every tier below
   2560px (2560px+ is intentionally left exactly as it was). */
.phone-frame {
    width: 236px;
    height: 460px;
}
