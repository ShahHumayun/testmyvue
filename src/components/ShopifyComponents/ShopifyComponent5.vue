<template>
    <section
        ...
        <div class="max-w-4xl mx-auto text-center space-y-12">
            <h2 class="text-sm font-bold tracking-widest uppercase accent-text testimonials-main-tag">Trusted By
                Ecommerce
                Brands</h2>
            ...
            <div class="relative min-h-[120px] flex items-center justify-center">
                <transition name="carousel-fade" mode="out-in">
                    <blockquote :key="active"
                        class="text-xl md:text-2xl font-medium leading-relaxed italic max-w-2xl quote-text">
                        "{{ testimonials[active] }}"
                    </blockquote>
                </transition>
            </div>
