      ...
      <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-20 w-full pt-20 pb-12">
        ...
        <div class="lg:col-span-5 flex justify-center order-1 lg:order-2 perspective-1000">
          <div
            ref="phoneWireframe"
            :class="[
              'relative w-72 h-[560px] border-[4px] rounded-[44px] p-3.5 shadow-[0_0_60px_rgba(0,255,163,0.18)] transition-transform duration-200 ease-out will-change-transform ring-1',
              isDarkMode
                ? 'border-neutral-800 bg-neutral-950 border-t-neutral-700 border-b-neutral-900 ring-neutral-800/50'
                : 'border-black bg-neutral-50 border-t-black border-b-black ring-black/20'
            ]"
          ...
          >
            ...
            >
              ...
              <div class="grid grid-cols-2 gap-2 my-1.5 relative z-10">
                <div
                  :class="[
                    'p-2.5 rounded-xl flex flex-col justify-between h-16 hover:border-[#00ffa3]/30 transition-colors border',
                    isDarkMode ? 'bg-neutral-900/30 border-neutral-900/80' : 'bg-neutral-100/70 border-neutral-200'
                  ]"
                >
              ...
              <div
                :class="[
                  'mt-3 pt-2 border-t flex justify-around items-center relative z-10',
                  isDarkMode ? 'border-neutral-900 text-neutral-600' : 'border-neutral-200 text-neutral-400'
                ]"
              >
...
// Theme prop passed down from AppDevelopment.vue, same as ReplacementGlass.vue's children
defineProps({
  isDarkMode: {
    type: Boolean,
    default: true
