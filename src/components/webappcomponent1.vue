<!-- <template>
  <div :class="['page-wrapper', isDarkMode ? 'theme-dark' : 'theme-light']">
    ...
    <section class="relative min-h-screen flex items-center justify-center px-6 overflow-hidden border-b border-neutral-900 z-20 pt-24">
      <div class="absolute inset-0 bg-[linear-gradient(to_right,#051e14_1px,transparent_1px),linear-gradient(to_bottom,#051e14_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_70%,transparent_100%)] opacity-60"></div>
      
      <div class="max-w-5xl mx-auto text-center relative z-20 space-y-6 mt-16">
        ...
        <h1 ref="heroTitle" class="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.1] text-transparent bg-clip-text bg-gradient-to-b from-white to-neutral-400">
        ...
        <p ref="heroSubtitle" class="max-w-2xl mx-auto text-neutral-400 text-base md:text-xl leading-relaxed">
        ...
        <div ref="heroButtons" class="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
...
import Header from './Header.vue' // Adjust import path based on file directory
